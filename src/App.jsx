...
const style = `
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  html, body { width:100%; overflow-x:hidden; overflow-x:clip; margin:0; padding:0; -webkit-text-size-adjust:100%; background:var(--bg); color:var(--text); font-family:'Noto Sans JP',sans-serif; font-weight:400; min-height:100vh; min-height:100dvh; position:relative; }
  .app { width:100%; max-width:100vw; max-width:100dvw; margin:0 auto; padding:0 0 80px; min-height:100vh; min-height:100dvh; box-sizing:border-box; overflow-x:hidden; overflow-x:clip; display:flex; flex-direction:column; position:relative; }
  .header, .tabs, .task-list { width:100%; max-width:100%; flex-shrink:0; }
